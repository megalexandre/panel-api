...
class Bordero
  class CalculateForm
    ...
    PERMITTED_PARAMS = [:change_date, :monthly_rate_percent, :awaiting_days, { receivables: [:amount_cents, :due_date] }].freeze

    attr_accessor :change_date, :monthly_rate_percent, :awaiting_days, :receivables
